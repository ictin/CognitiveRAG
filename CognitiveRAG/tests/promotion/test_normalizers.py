...
def test_normalize_proposition_has_stable_fields():
    unit = normalize_proposition(
        "The user said that user prefers automation.",
        provenance={"session_id": "s1", "created_at": "2026-04-12T10:00:00Z"},
    )
    ...
    assert unit.freshness_state in {"hot", "warm", "stale", "unknown"}
